	...
	<!--start-wrap--->
		<div class="wrap">
			<!---start-header---->
				<div class="header">
					<div class="logo">
						<h1><a href="#">Ohh.. we're unable to find the treasure..</a></h1>
					</div>
				</div>
			<!---End-header---->
			<!--start-content------>
			<div class="content">
				...
				<div class="copy-right">
					<p>&copy; Copyright 2018. POSWIn and all of the products of Obelisk Software + Design. All rights reserved.</p>
				</div>
			</div>
			<!--End-Cotent------>
		</div>
